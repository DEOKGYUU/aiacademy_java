...
public class PlayerApp {
	public static void main(String[] args) {
		...
		if(players[0].getRecord() < players[1].getRecord() && players[0].getRecord() < players[2].getRecord()) {
			ranking[0] = players[0];
		...
		} else if(players[1].getRecord() < players[0].getRecord() && players[1].getRecord() < players[2].getRecord()) {
			ranking[0] = players[1];
